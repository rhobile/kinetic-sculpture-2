...
export function VideoPlayerModal({ image, isOpen, onClose }: VideoPlayerModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl w-[95vw] sm:w-full p-0 overflow-hidden border-none shadow-2xl rounded-none bg-background focus:outline-none flex flex-col">
        <div className="w-full flex flex-col">
          ...
          <div className="px-4 sm:px-6 py-6 bg-background border-t border-border/10 relative z-10">
            <DialogHeader className="space-y-3 text-left">
              <DialogTitle className="font-normal text-[13pt] tracking-[0.1em] text-foreground uppercase m-0 p-0 leading-tight">
                {image.alt}
              </DialogTitle>
